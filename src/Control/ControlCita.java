...
import inet.jortho.FileUserDictionary;
...
public class ControlCita {
    ...
    private void referenciarObjetos() {
        ...
        //apliacion del diccionario
        SpellChecker.setUserDictionaryProvider(new FileUserDictionary());
        SpellChecker.registerDictionaries(getClass().getResource("/diccionario/dictionaries.cnf"), null);

        //1true activa menu cabio palabra 4activa color rojo palabra
        SpellChecker.register(Vcita.getTatCmotivos(), true, false, false, true);
        SpellChecker.register(Vcita.getTatCtratamiento(), true, false, false, true);
        SpellChecker.register(Vcita.getTatCobservaciones(), true, false, false, true);
    }
