...
public class VistaCita extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        pnlCmascota.add(lblnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, -1, -1));
        ...
        lblfc.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/frecuencia_cardiaca_26px.png"))); // NOI18N
        lblfc.setText("Fc");
        ...
        lblpeso.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/peso_26px.png"))); // NOI18N
        lblpeso.setText("Peso");
        pnlCmascota.add(lblpeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 477, -1, -1));
        ...
        lblfr.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/frecuencia_respiratoria_26px.png"))); // NOI18N
        lblfr.setText("Fr");
        ...
        lblcapilar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/encias_26px.png"))); // NOI18N
        lblcapilar.setText("T.Llenado capilar");
        pnlCmascota.add(lblcapilar, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 546, -1, -1));
        pnlCmascota.add(txtCllenado, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 570, 120, -1));

        lbltemperatura.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/temperatura_26px.png"))); // NOI18N
        lbltemperatura.setText("Temperatura rectal");
        pnlCmascota.add(lbltemperatura, new org.netbeans.lib.awtextra.AbsoluteConstraints(19, 408, 190, 23));

        jspCtem.setModel(new javax.swing.SpinnerNumberModel(37.5d, 1.0d, 45.0d, 1.0d));
        pnlCmascota.add(jspCtem, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 430, 120, -1));
        ...
        pnlCmascota.add(jspChidra, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 360, 120, -1));

        lblhidrata.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/agua_26px.png"))); // NOI18N
        lblhidrata.setText("Hidratación");
        pnlCmascota.add(lblhidrata, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 340, 130, 20));

        lblprocentaje.setText("%");
        pnlCmascota.add(lblprocentaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 380, -1, -1));

        lblmucosa.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Iconos/citas/mucosidad_26px.png"))); // NOI18N
        lblmucosa.setText("Muscosa");
        pnlCmascota.add(lblmucosa, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 615, -1, -1));
        ...
        pnlCmascota.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 110, 10));
        ...
        pnlCmascota.add(lblCcedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 110, 20));
        pnlCmascota.add(lblCnombreP, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 140, 340, 20));
